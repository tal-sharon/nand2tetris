...
class Parser:
    ...
    def advance(self) -> None:
        ...
        if cmd == "C_ARITHMETIC" or cmd == "C_RETURN":
    ...
    def command_type(self) -> str:
        ...
        if cur_first_part in arithmetic_logical:
            return "C_ARITHMETIC"
        elif cur_first_part == "push":
            return "C_PUSH"
        elif cur_first_part == "pop":
            return "C_POP"
        elif cur_first_part == "label":
            return "C_LABEL"
        elif cur_first_part == "goto":
            return "C_GOTO"
        elif cur_first_part == "if-goto":
            return "C_IF"
        elif cur_first_part == "function":
            return "C_FUNCTION"
        elif cur_first_part == "return":
            return "C_RETURN"
        elif cur_first_part == "call":
            return "C_CALL"
